...
function renderProductSection($pdo, $type, $title) {
    global $is_admin, $userId; // Utilisation de $is_admin et $userId
    ...
    try {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            // Si l'utilisateur est connecté, le bouton soumet vers `add_to_cart.php`. Sinon, il redirige vers `connexion.html`.
            $formAction = $userId ? "add_to_cart.php" : "connexion.html";
            echo "
