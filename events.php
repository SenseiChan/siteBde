    ...
    <?php foreach ($upcomingEventsGrouped as $month => $events): ?>
        <div class="month-section">
            ...
            <?php foreach ($events as $event): ?>
                <?php 
                    $eventId = 'event_' . $event['Id_event'];
                    $isRegistered = isUserRegistered($pdo, $userId, $event['Id_event']);
                    $isInCart = isset($_SESSION['cart'][$eventId]);
                ?>
                <div class="event-card">
                    ...
                    <div class="event-info">
                        ...
                        <form method="post" action="add_to_cart.php">
                            ...
                            <button type="submit" 
                                class="add-to-cart-btn <?= $isRegistered || $isInCart ? 'disabled' : '' ?>">
                                <?= $isRegistered ? 'Déjà inscrit' : ($isInCart ? 'Déjà ajouté' : 'Ajouter au panier') ?>
                            </button>
                        </form>
                    </div>
                </div>
